...
ras_all_df = pd.read_csv('/data/home/aboussif/Projet14/deliverable/topologie/data/BCL2/all/all_bcl2.csv')
distances_ras_all = ras_all_df['Distance'].values

# Charger les distances Ras-Ras
ras_ras_df = pd.read_csv('/data/home/aboussif/Projet14/deliverable/topologie/data/BCL2/bcl2/silico/distance_results_barcode1.csv')
