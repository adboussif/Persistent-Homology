...
if __name__ == "__main__":
    input_path = "/data/home/tfoussenisalamicisse/projet_hp/pdb_files_dosoph/pdb_files/pdb_filtre/pdb_ca_files"
    output_dir = "/data/home/tfoussenisalamicisse/projet_hp/pdb_files_dosoph/pdb_files/pdb_filtre/results"

    files = os.listdir(input_path)
    process_file_partial = partial(process_file, input_path, output_dir)

    with ThreadPoolExecutor() as executor:
        executor.map(process_file_partial, [file for file in files if file.endswith('.pdb')])
